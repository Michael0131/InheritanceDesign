...
void Move::read(const string& s)
{
    ...
    // Use board coordinates directly
...
string Move::getText() const
{
    ...
    string s;
    // Use col/row directly (0..7)
    s.push_back('a' + source.getCol());   // file
    s.push_back('1' + source.getRow());   // rank
    s.push_back('a' + dest.getCol());     // file
    s.push_back('1' + dest.getRow());     // rank
